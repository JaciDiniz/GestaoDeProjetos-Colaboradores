...
{
    class GestorRedes: Colaborador
    {
        public GestorRedes(string nome, int nif, string morada, string habilitacao, double valorhora, string tec)
        ...
        {
            SqlCommand command = new SqlCommand("UPDATE colaborador SET nome = @nome, morada = @morada, habilitacao = @habilitacao, valorhora = @valorhora, tecnologias = @tec WHERE nif ='" + Nif + "';"); command.Parameters.AddWithValue("@nome", Nome);
